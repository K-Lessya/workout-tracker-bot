...
class EnglishTranslations(Enum):
    ...
    trainer_add_exercise_ask_for_media = "Do you want to upload a photo or a video which will show exercise technique?"
    trainer_add_exercise_process_media = 'Then send me a photo or a video which will show exercise technique\n' \
                                         'It will be better if the photo will consist of two positions in the exercise'
    trainer_add_exercise_process_media_text_recieved = "You need to send a photo or a video"
    ...
    trainer_my_clients_menu_no_clients = "You don't have any clients now\nAdd them from an add client menu"
    trainer_my_clients_menu_single_client_menu = "Client:\nName: {}\nSurname: {}"
    trainer_my_clients_menu_single_client_create_plan_select_exercise = "Let's choose an exercise for the day {} or you can create new exercise"
    ...
    trainer_my_clients_menu_single_client_create_plan_no_exercises = "There are no exercises in your db yet, just add one"
    ...
    trainer_create_plan_add_trainer_note = 'Add your own note or recommendation for a client about technique (This is a basic recommendation, which will be shown to a client with an exercise)'
    ...
    trainer_my_clients_menu_single_client_publish_plan = "Publish plan to the client"
    trainer_my_clients_menu_single_client_publish_plan_notification = "This plan will become active in the client menu and will replace current plan if one exists"
    ...
    trainer_my_clients_edit_plan_exercise_change_trainer_note = "Edit a trainer note"
    ...
    trainer_my_clients_menu_single_client_view_trainings_show_exercise = "Exercise: {}\n" \
                                                                         "Runs x Repeats: {}x{}\n" \
                                                                         "Working weight: {} kg"
    trainer_my_clients_menu_single_client_view_trainings_update_comment = "Update a comment"
    ...
    trainer_exercise_plan_list_keyboard_save_day = "Go back to the day exercises list"
    ...
    client_requests_show_request = "Request from the trainer:\n{} {}\nAccept request?"
    client_requests_accept_request = "Congratulations, from now {} {} is your trainer"
    client_requests_accept_request_trainer_notification = "{} {} has accepted you request, now you can view him(her) in the client's list"
    ...
    client_my_plan_show_day = "Here are your exercises for the day {}, if you are struggling with the technique just select an exercise"
    ...
    client_my_trainings_show_video_no_trainer_comment = "Trainer still haven't added any comments about your technique"
