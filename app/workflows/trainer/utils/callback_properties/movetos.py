...
class AddExerciseMoveTo:
    create_body_part = 'create_body_part'


class AddClientMoveTo:
...
class MyCLientsMoveTo:
    ...
    append_trainer_note = 'append_trainer_note'
    ...
    append_video_comment = 'my_clients_append_video_comment'
