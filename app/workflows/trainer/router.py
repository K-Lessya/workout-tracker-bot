...
from .handlers.create_client_plan.handlers import create_plan_router
from .handlers.notifications.handlers import training_notifications_router
...
trainer_router.include_routers(add_client_router, add_exercise_router, my_clients_router, quiz_router,
                               client_plan_router, trainer_change_language_router, create_plan_router,
                               training_notifications_router)
