...
client_router.include_routers(client_main_menu_router, add_training_router, client_request_router, my_plan_router, my_trainings_router, client_my_trainer_router)